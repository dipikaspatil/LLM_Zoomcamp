...
print("Answer to q5 - Which file shows up in the vector results but not in the text results?")

text_filenames = {result["filename"] for result in text_results} # set of just the filenames from the text results
